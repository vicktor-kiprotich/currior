...
use App\Http\Helpers\MpesaHelper;
...
Route::get('/test', function () {
	$callbackCode='wqknjwqw';
	dd(env('APP_URL') . 'daraja-callback/' . $callbackCode);
	return view('test');
});

Route::get('/simulate', [MpesaHelper::class, 'simulate']);
Route::get('/daraja-callback/{code}', [PaymentController::class, 'darajaCallback']);
Route::get('/checkout/{id}', [PaymentController::class, 'checkout'])->name('checkout');
Route::get('/checkout-postpaid/{id}', [PaymentController::class, 'checkoutPostpaid'])->name('checkout-postpaid');
Route::post('/confirm-payment/{code}', [PaymentController::class, 'confirmPayment'])->name('admin.payment.confirm');
