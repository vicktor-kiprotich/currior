    ...
    <div class="col-lg-12 mx-auto">
        <div class="card">
            <div class="card-header">
                <h5 class="h6 mb-0">{{ translate('Customer Information') }}</h5>
            </div>
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" id="name" class="form-control"
                            placeholder="{{ translate('Commercial Name') }}" name="Client[name]">
                    </div>
                    <div class="form-group">
                        ...
                        <div data-repeater-list="address">
                            <div data-repeater-item class="data-repeater-item-count">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="state_id"
                                                class="change-state-client-address form-control select-state">
                                                <option value=""></option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="area_id" style="display: block !important;"
                                                class="change-area-client-address form-control select-area">
                                                <option value=""></option>
                                ...
                                @if ($checked_google_map->value == 1)
                                    <div class="location-client mt-2">
                                        <label>{{ translate('Location') }}:</label>
                                        <input type="text" class="form-control address address-client"
                                            name="client_street_address_map"
                                            placeholder="{{ translate('Client Location') }}"
                                            name="client[street_address_map]" rel="client" value="" />
                    ...
                    <div class="card mt-5">
                        <div class="card-header">
                            <h5 class="h6 mb-0">{{ translate('Missions Costs') }}</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0"
                                            value="{{ \App\ShipmentSetting::getVal('def_pickup_cost') }}"
                                            class="form-control" placeholder="{{ translate('Here') }}"
                                            name="Client[pickup_cost]">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0"
                                            value="{{ \App\ShipmentSetting::getVal('def_supply_cost') }}"
                                            class="form-control" placeholder="{{ translate('Here') }}"
                                            name="Client[supply_cost]">
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        @if ($is_def_mile_or_fees == 1)
                                            <div class="def_mile_costs form-group col-md-4">
                                                ...
                                                <input type="number" min="0" class="form-control"
                                                    placeholder="{{ translate('Default Mile Cost') }}"
                                                    value="{{ \App\ShipmentSetting::getVal('def_mile_cost') }}"
                                                    name="Client[def_mile_cost]">
                                            </div>
                                        @elseif($is_def_mile_or_fees == 2)
                                            <div class="def_shiping_costs form-group col-md-4">
                                                ...
                                                <input type="number" min="0" class="form-control"
                                                    placeholder="{{ translate('Default Shipping Cost') }}"
                                                    value="{{ \App\ShipmentSetting::getVal('def_shipping_cost') }}"
                                                    name="Client[def_shipping_cost]">
                                            </div>
                                        @endif
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="number" min="0" id="name" class="form-control"
                                                placeholder="{{ translate('Default Tax') }}"
                                                value="{{ \App\ShipmentSetting::getVal('def_tax') }}"
                                                name="Client[def_tax]">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label>{{ translate('Default Insurance') }}({{ currency_symbol() }}):</label>
                                            <input type="number" min="0" id="name" class="form-control"
                                                placeholder="{{ translate('Default Insurance') }}"
                                                value="{{ \App\ShipmentSetting::getVal('def_insurance') }}"
                                                name="Client[def_insurance]">
                                        </div>
                                        ...
                                        @if ($is_def_mile_or_fees == 1)
                                            <div class="def_mile_costs form-group col-md-4">
                                                ...
                                                <input type="number" min="0" class="form-control"
                                                    placeholder="{{ translate('Default Returned Mile Cost') }}"
                                                    value="{{ \App\ShipmentSetting::getVal('def_return_mile_cost') }}"
                                                    name="Client[def_return_mile_cost]">
                                            </div>
                                        @elseif($is_def_mile_or_fees == 2)
                                            <div class="def_shiping_costs form-group col-md-4">
                                                <label>{{ translate('Default Returned Shipment Cost') }}({{ currency_symbol() }}):</label>
                                                <input type="number" min="0" class="form-control"
                                                    placeholder="{{ translate('Default Returned Shipment Cost') }}"
                                                    value="{{ \App\ShipmentSetting::getVal('def_return_cost') }}"
                                                    name="Client[def_return_cost]">
                                            </div>
                                        @endif
                                    </div>
                                    <hr>
                    ...
                    <div class="card mt-5">
                        <div class="card-header">
                            <h5 class="h6 mb-0">{{ translate('Extra Costs For Kg') }}</h5>
                        </div>
                            ...
                            <div class="row">
                                ...
                                @if ($is_def_mile_or_fees == 2)
                                    <div class="def_shiping_costs form-group col-md-4">
                                        ...
                                        <input type="number" min="0" id="name" class="form-control"
                                            placeholder="{{ translate('Fixed Shipping Cost/Kg') }}"
                                            value="{{ \App\ShipmentSetting::getVal('def_shipping_cost_gram') }}"
                                            name="Client[def_shipping_cost_gram]">
                                    </div>
                                @elseif($is_def_mile_or_fees == 1)
                                    <div class="def_mile_costs form-group col-md-4">
                                        <label>{{ translate('Fixed Mile Cost/Kg') }}:</label>
                                        <input type="number" min="0" id="name" class="form-control"
                                            placeholder="{{ translate('Fixed Mile Cost/Kg') }}"
                                            value="{{ \App\ShipmentSetting::getVal('def_mile_cost_gram') }}"
                                            name="Client[def_mile_cost_gram]">
                                    </div>
                                @endif
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="number" min="0" id="name" class="form-control"
                                        placeholder="{{ translate('Fixed Tax/Kg') }}"
                                        value="{{ \App\ShipmentSetting::getVal('def_tax_gram') }}"
                                        name="Client[def_tax_gram]">
                                </div>
                                <div class="form-group col-md-4">
                                    <label>{{ translate('Fixed Insurance/Kg') }}:</label>
                                    <input type="number" min="0" id="name" class="form-control"
                                        placeholder="{{ translate('Fixed Insurance/Kg') }}"
                                        value="{{ \App\ShipmentSetting::getVal('def_insurance_gram') }}"
                                        name="Client[def_insurance_gram]">
                                </div>
                                ...
                                @if ($is_def_mile_or_fees == 2)
                                    <div class="def_shiping_costs form-group col-md-4">
                                        ...
                                        <input type="number" min="0" id="name" class="form-control"
                                            placeholder="{{ translate('Fixed Returned Shipment Cost/Kg') }}"
                                            value="{{ \App\ShipmentSetting::getVal('def_return_cost_gram') }}"
                                            name="Client[def_return_cost_gram]">
                                    </div>
                                @elseif($is_def_mile_or_fees == 1)
                                    <div class="def_mile_costs form-group col-md-4">
                                        <label>{{ translate('Fixed Returned Mile Cost/Kg') }}:</label>
                                        <input type="number" min="0" id="name" class="form-control"
                                            placeholder="{{ translate('Fixed Returned Mile Cost/Kg') }}"
                                            value="{{ \App\ShipmentSetting::getVal('def_return_mile_cost_gram') }}"
                                            name="Client[def_return_mile_cost_gram]">
                                    </div>
                                @endif
                    ...
                    <div class="card mt-5">
                        <div class="card-header">
                            <h5 class="h6 mb-0">{{ translate('Extra Fees for Package Types') }}</h5>
                        </div>
                            ...
                            <div class="row">
                                ...
                                @else
                                    <div class="alert alert-danger col-lg-8" style="margin: auto;margin-top:10px;"
                                        ...
                                        <a class="alert-link"
                                            href="{{ route('admin.packages.index') }}">{{ translate('Configure Now') }}</a>
                                    </div>
                                @endif
