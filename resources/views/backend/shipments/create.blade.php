...
@section('subheader')
    ...
    <div class="my-body subheader py-lg-6 subheader-solid py-2" id="kt_subheader">
        <div style="  "
            class="container-fluid d-flex align-items-center justify-content-between flex-sm-nowrap flex-wrap">

            <div class="d-flex align-items-center mr-1 flex-wrap">

                <div class="d-flex align-items-baseline mr-5 flex-wrap">

                    <h5 class="text-dark font-weight-bold my-1 mr-5">{{ translate('Create Shipment') }}</h5>
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold font-size-sm my-2 mr-5 p-0">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('admin.shipments.index') }}"
                                class="text-muted">{{ translate('Shipments') }}</a>
                        </li>
                        <li class="breadcrumb-item text-muted">
...
<div class="col-lg-12 mx-auto">
    <div class="card">
        ...
        @else
            @if (
                \App\ShipmentSetting::getVal('def_shipping_cost') == null ||
                    count($countries) == 0 ||
                    \App\State::where('covered', 1)->count() == 0 ||
                    \App\Area::count() == 0 ||
                    count($packages) == 0 ||
                    $branchs->count() == 0 ||
                    $clients->count() == 0)
                <div class="row">
                    <div class="alert alert-danger col-lg-8 text-center" style="margin: auto;margin-top:10px;"
                        role="alert">
        ...
        <form class="form-horizontal" action="{{ route('admin.shipments.store') }}" class="my-form" id="kt_form_1"
                            ...
                            <div class="col-9 col-form-label">
                                <div class="radio-inline">
                                    <label class="radio radio-success btn btn-default">
                                        <input @if (\App\ShipmentSetting::getVal('def_shipment_type') == '1') checked @endif type="radio"
                                            name="Shipment[type]" checked="checked" value="1" />
                                        <span></span>
                                        {{ translate('Pickup (For door to door delivery)') }}
                                    </label>
                                    <label class="radio radio-success btn btn-default">
                                        <input @if (\App\ShipmentSetting::getVal('def_shipment_type') == '2') checked @endif type="radio"
                                            name="Shipment[type]" value="2" />
                                        <span></span>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control kt-select2 select-branch" name="Shipment[branch_id]">
                                        ...
                                        @foreach ($branchs as $branch)
                                            <option @if (\App\ShipmentSetting::getVal('def_branch') == $branch->id) selected @endif
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group client-select">
                                    ...
                                    @else
                                        <input placeholder="{{ translate('Client name') }}"
                                            name="Shipment[client_id]" id="client_id" class="form-control" />
                            ...
                            {{-- <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select id="my-client-address" name="Shipment[client_address]"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 d-none">
                                    <div class="form-group">
                                        ...
                                        {{-- <select id="client-state-id" name="state_id" locateReceiverPin
                                            class="form-control select-state">
                                            <option value=""></option>
                                        </select> --}}

                                        <input type="text" placeholder="{{ translate('Region') }}"
                                            name="state_id" id="client-state-id" class="form-control" required />
                                    </div>
                                </div>
                            </div>

                            <div class="form-group ">
                                <label class="d-none">{{ translate('Area') }}:</label>
                                {{-- <select name="area_id" style="display: block !important;" id="client-area-id"
                                    class="form-control select-area">
                                    <option value=""></option>
                                </select> --}}
                                <input type="text" placeholder="{{ translate('Area') }}" name="client_area_id"
                                    id="client-area-id" class="form-control d-none" required />
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="row w-100">
                                    <div class="col-md-11 w-100 col-sm-11">

                                        <input type="text" placeholder="{{ translate('Address') }}"
                                            name="address" id="client-address-complete" class="form-control"
                                            required />
                                    </div>
                                    <div class="col-md-1 w-100 col-sm-1">
                                        ...
                                        align-items: center;"
                                            class="btn btn-primary btn-square rounded text-center">
                            ...
                            {{-- <div class="col-md-12 mb-4 p-3" id="show_address_div"
                                style="border: 1px solid #e4e6ef; display:none">
                                ...
                                <div class="form-group d-none">
                                    ...
                                    <input type="text" placeholder="{{ translate('Area') }}"
                                        name="client_area_id" id="client-area-id" class="form-control" required />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row w-100">
                                        <div class="col-md-11 w-100 col-sm-11">
                                            ...
                                            <input type="text" placeholder="{{ translate('Address') }}"
                                                name="area_id" id="client-address-complete" class="form-control"
                                                required />
                                        </div>
                                        <div class="col-md-1 w-100 col-sm-1">
                                            <button type="button" id="getCurrentLocationBtn"
                                ...
                                @if ($checked_google_map->value == 1)
                                    <div class="location-client">
                                        ...
                                        <input type="text" class="form-control address-client"
                                            ...
                                            name="client_street_address_map" rel="client" value="" />
                                        <input type="hidden" class="form-control lat" data-client="lat"
                                            name="client_lat" />
                                        <input type="hidden" class="form-control lng" data-client="lng"
                                            name="client_lng" />
                                        <input type="hidden" class="form-control url" data-client="url"
                                            name="client_url" />

                                        <div class="col-sm-12 map_canvas map-client mt-2"
                                ...
                                <div class="mt-4">
                                    <button type="button" class="btn btn-primary"
                                        onclick="AddNewClientAddress()">{{ translate('Save') }}</button>
                                    <button type="button" class="btn btn-secondary"
                                        onclick="closeAddressDiv()">{{ translate('Close') }}</button>
                                </div>
                            </div> --}}
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input placeholder="Client location" name="Shipment[client_street_address_map]"
                                        id="clientLocation" readonly class="form-control d-none" id="" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="{{ translate('Receiver Address') }}"
                                        id="receiver-address-input" name="Shipment[reciver_address]"
                                        class="form-control" />
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input placeholder="Receiver location" name="Shipment[reciver_street_address_map]"
                                        id="receiverLocation" readonly class="form-control d-none" id="" />
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="location-receiver">
                                        ...
                                        <input type="text" class="form-control address-receiver"
                                            ...
                                            value="" />
                                        <input type="hidden" class="form-control lat" data-receiver="lat"
                                            name="Shipment[reciver_lat]" />
                                        <input type="hidden" class="form-control lng" data-receiver="lng"
                                            name="Shipment[reciver_lng]" />
                                        <input type="hidden" class="form-control url" data-receiver="url"
                        ...
                        <div class="row d-none">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="{{ translate('Receiver Address') }}"
                                        id="from-region-id" name="Shipment[from_state_id]" class="form-control" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>{{ translate('To Region') }}:</label>
                                    <input type="text" placeholder="{{ translate('') }}" id="to-state-id"
                                        name="Shipment[to_state_id]" class="form-control" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 d-none">
                                <div class="form-group">
                                    <label class="d-none">{{ translate('From Area') }}:</label>
                                    <input type="text" placeholder="{{ translate('Receiver Address') }}"
                                        id="from_area_id" name="Shipment[from_area_id]"
                                        class="form-control d-none" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="d-none">{{ translate('To Area') }}:</label>
                                    <input type="text" placeholder="{{ translate('') }}" id="to_area_id"
                                        name="Shipment[to_area_id]" class="form-control d-none" />
                                </div>
                                    ...
                                    <select class="form-control kt-select2 payment-method" id="payment_method_id"
                                        ...
                                        @forelse (\App\BusinessSetting::where("key","payment_gateway")->where("value","1")->get() as $gateway)
                                            <option value="{{ $gateway->id }}"
                                                @if ($gateway->id == 11) selected @endif>{{ $gateway->name }}
                                            </option>
                                        @empty
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group" data-toggle="aizuploader" data-type="image"
                                        ...
                                        <input type="hidden" name="Shipment[attachments_before_shipping]"
                                            ...
                                            value="{{ old('Shipment[attachments_before_shipping]') }}"
                                            max="3">
                                    </div>
                                ...
                                <div data-repeater-list="Package" class="col-lg-12">
                                    <div data-repeater-item class="row align-items-center"
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input class="kt_touchspin_qty" placeholder="{{ translate('Quantity') }}"
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input class="dimensions_r" type="number" min="1"
                                                class="form-control" placeholder="{{ translate('Length') }}"
                                                name="length" value="1" />
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input class="dimensions_r" type="number" min="1"
                                                class="form-control" placeholder="{{ translate('Width') }}"
                                                name="width" value="1" />
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input class="dimensions_r" type="number" min="1"
                                                class="form-control" placeholder="{{ translate('Height') }}"
                                                name="height" value="1" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control kt-select2 delivery-time" id="delivery_time"
                                            ...
                                            @foreach ($deliveryTimes as $deliveryTime)
                                                <option value="{{ $deliveryTime->name }}">
                                                    {{ translate($deliveryTime->name) }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="kt_touchspin_4" placeholder="{{ translate('Total Weight') }}"
                                            type="text" min="1" class="form-control total-weight"
                                            value="1" name="Shipment[total_weight]" />
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <button type="button" class="close" data-dismiss="modal"
                                            aria-label="Close" id="modal_close">
...
@section('script')
<script>
    let clientAddressAutocomplete;

    function getCurrentLocationAndTriggerPlaceChanged(autocompletePlace, callback) {
    ...
    document.getElementById('getCurrentLocationBtn').addEventListener('click', function() {
        ...
        if (clientAddressInput) {
            getCurrentLocationAndTriggerPlaceChanged(clientAddressAutocomplete, function(locationData) {
                if (locationData) {
                    console.log('Current Coordinates:', locationData.coordinates);
                    console.log('Current Address:', locationData.address);
                    clientAddressInput.value = locationData.address
                } else {
            ...
            console.error("Element with ID 'client-address-complete' not found.");
        }
    });
</script>
...
<script>
    ...
    $(document).ready(function() {
        ...
        const clientAddressInput = document.getElementById('client-address-complete');
        clientAddressAutocomplete = new google.maps.places.Autocomplete(clientAddressInput, {
            componentRestrictions: {
                country: 'KE'
            }
        });
        ...
        receiverAddressAutocomplete.addListener('place_changed', function() {
            ...
            setAreaAttribute(receiverPlaceCoordinates, 'receiver');
...
<script type="text/javascript">
    ...
    function selectIsTriggered() {
        ...
        allClients.forEach((client) => {
            if (client.id == clientId) {
                console.log(client)
                $('#client_phone').val(client.responsible_mobile);
            }
        })
    ...
    $(document).ready(function() {
        ...
        allCountries.forEach((country) => {
            if (country.name == 'Kenya') {
                id = country.id;
                $("#change-country").val(id)
                $('#change-country-client-address').val(id)
            }
        })


        console.log("{{ route('client.get.one.address') }}");
    ...
    function AddNewClientAddress() {
        ...
        @endif
        var address = $('#client-address-complete').val();
        ...
        @else
            if (address != "" || country != "" || state != "") {
                $.post("{{ route('client.add.new.address') }}", {
                    ...
                    $('#my-client-address').val(data[data.length - 1].id);
    ...
    //         for (let index = 0; index < data.length; index++) {
    //             const element = data[index];
    //             $('select[name ="area_id"]').append('<option value="' + element['id'] + '">' + element[
    //                 'name'] + '</option>');
    //         }
        ...
        FormValidation.formValidation(
            document.getElementById('kt_form_1'), {
                fields: {
                    ...
                    "Shipment[reciver_street_address_map]": {
                        validators: {
                            notEmpty: {
                                message: '{{ translate('This map field is required!') }}'
                            }
                        }
                    },
                    "Shipment[client_street_address_map]": {
                        validators: {
                            notEmpty: {
                                message: '{{ translate('This map field is required!') }}'
                            }
                    ...
                    "Shipment[to_area_id]": {
                        validators: {
                            notEmpty: {
                                message: '{{ translate('Invalid receiver address!!') }}'
                            }
                        }
                    },
