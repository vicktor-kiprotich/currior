    ...
    <div class="brand flex-column-auto" id="kt_brand">
        ...
        <a href="{{ route('admin.dashboard') }}" class="brand-logo">
            @if(get_setting('system_logo_white') != null)
                <img src="{{ uploaded_asset(get_setting('system_logo_white')) }}" style="width:100%;max-height: 25px;" alt="@if(get_setting('site_name')) {{ get_setting('site_name') }} @else {{ translate('FS Express') }} @endif">
            @else
                <img src="{{ static_asset('assets/img/logo.svg') }}" style="max-height: 25px;" alt="@if(get_setting('site_name')) {{ get_setting('site_name') }} @else {{ translate('FS Express') }} @endif">
            @endif
        </a>
