...
class ClientController extends Controller
{
    ...
    public function save(Request $request)
    {
        ...
        try {
            ...
            $model->responsible_mobile = $request->mobile;
            $model->code = -1;
    ...
    {
        $addressExists = AddressClient::query()->where('client_id', $request->client_id)->where('address', $request->address)->first();

        if ($addressExists) {
            flash('Address exists', 'error');
            return back();
        }
