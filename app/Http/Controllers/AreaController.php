...
class AreaController extends Controller
{
    ...
    public function create()
    {
       $countries= \App\Country::where('covered', 1)->get();
        return view('backend.shipments.create-area')->with(['countries'=>$countries]);
    }
    ...
    public function store(Request $request)
    {
        ...
        if(!$request->Area['geofence']){
            flash(translate('The area map field is required.'))->error();
            return back();
        }
    ...
    public function edit($id)
    {
       ...
       $countries= \App\Country::where('covered', 1)->get();
        ...
        return view('backend.shipments.edit-area',compact('area','countries'));
    }
