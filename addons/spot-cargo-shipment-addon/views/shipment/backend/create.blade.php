                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select id="client-addressess" name="Shipment[client_address]"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input placeholder="Sender's location" name="Shipment[sender_location]"
                                        id="sender_location" class="form-control" />
                            ...
                            <div class="col-md-12 mb-4 p-3" id="show_address_div"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="change-state-client-address" name="state_id"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="{{ translate('Address') }}"
                                        name="client_address" class="form-control" required />
                                </div>
                                @if ($checked_google_map->value == 1)
                                    <div class="location-client">
                                        ...
                                        <input type="hidde--n" class="form-control lat" data-client="lat"
                                            name="client_lat" />
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input placeholder="Receiver's location" name="Shipment[receiver_location]"
                                        id="receiver_location" class="form-control" />
                ...
                $.post("{{ route('client.add.new.address') }}", {
                    ...
                    for (let index = 0; index < data.length; index++) {
                        ...
                        $('select[name ="Shipment[client_address]"]').append('<option value="' + element[
                            'address'] + '">' + element['address'] + '</option>');
                    }
