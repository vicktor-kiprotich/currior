                                    ...
                                    <tr>
                                        <td width="81%" height="21px" valign="top">
                                            <table width="100%" border="0" align="center" cellpadding="0"
                                                ...
                                                <tr>
                                                    <td>
                                                        <table width="100%" border="0" align="center"
                                                            ...
                                                            <tr>
                                                                <td
                                                                    style="padding-left:10px; font-size:14px; font-weight:bold; width:420px">
                                                                    @if (get_setting('site_name'))
                                                                        {{ get_setting('site_name') . get_setting('site_motto') ? ' | ' . get_setting('site_motto') : '' }}{{ translate('FS Express') }}@else{{ translate('FS Express') }}
                                                                    @endif
                                                                </td>
                                                                <td nowrap="nowrap">
                                                                    <span
                                                                        style="font-size:20px; font-weight:bold; padding-right:10px;">{{ $shipment->code }}</span>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td
                                                        style="padding-left:10px;font-size: 14px;white-space: pre-line;word-wrap: break-word;max-width: 360px;">
                                                        {{ $shipment->reciver_address }}</td>
                                                </tr>
                                            </table>
                                            <table width="100%" border="0" align="center" cellpadding="0"
                                                cellspacing="0">
                                                <tr>
                                                    <td
                                                        style="border-top: 1px solid #000000; border-bottom: 0px solid #000000;">
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: center; padding-top: 10px;"
                                                                        ...
                                                                        @if ($shipment->amount_to_be_collected && $shipment->amount_to_be_collected > 0)
                                                                            <span
                                                                                style="font-size:16px; font-weight:bold; padding:10px;">{{ translate('COD') }}:
                                                                                {{ format_price($shipment->amount_to_be_collected) }}</span>
                                                                            <br />
                                                                        @endif
                                                                        <span
                                                ...
                                                <tr>
                                                    <td style="padding:5px; font-size:12px;">
                                                        <table width="100%" border="0" align="center"
                                                            ...
                                                            <tr>
                                                                <td
                                                                    style="font-size:12px;word-wrap: break-word;max-width: 360px;">
                                                                    <span
                                                                        style="font-weight:bold;">{{ translate('From') }}:
                                                                    </span>
                                                                    {{ is_object($shipment->client) ? $shipment->client->name : $shipment->client_id }}<br />
                                                                ...
                                                                <td
                                                                    style="font-size:12px;word-wrap: break-word;max-width: 360px;">
                                                                    <span
                                                                        style="font-weight:bold;">{{ translate('To') }}:
                                                                    </span>
                                            ...
                                            <table width="100%" border="0" align="center" cellpadding="0"
                                                cellspacing="0" style="margin-top:5px;border-top:#000000 1px solid;">
                                                <tr>
                                                    <td style="padding:5px; font-size:12px; text-align:center">
                                                        <span
                                                            style="font-weight:bold; font-size: 14px;">{{ translate('Contains') }}:
                                                        </span>
                                                        @php $i=0; @endphp
            ...
            <div class="upper-units-container">
                <div class="upper-units-container">
                    <div class="item-info-container float-left">
                        <span class="font-20">{{ translate('Shipment Code') }}:</span> <span
                            class="return-authorization font-20">{{ $shipment->code }}</span>
                    </div>
                    <div class="item-info-container text-align-right float-right">
                        {{ translate('Shipment date') }}:<span> {{ $shipment->shipping_date }}</span>
                    </div>
                </div>
                <div class="upper-units-container">

                    <div class="margin-top info-container text-wrap float-left">
                        @foreach (\App\PackageShipment::where('shipment_id', $shipment->id)->get() as $package)
                            ...
                            @if (isset($package->package->name))
                                <div class="item-info-container">
                                    <span class="bold">{{ translate('Package type') }}:</span>
                            ...
                            <div class="item-info-container">
                                <span class="bold">{{ translate('Weight x Length x Width x Height') }}:</span>
                                <span>{{ $package->weight . ' ' . translate('KG') . ' x ' . $package->length . ' ' . translate('CM') . ' x ' . $package->width . ' ' . translate('CM') . ' x ' . $package->height . ' ' . translate('CM') }}</span>
                            </div>
                            </br>
                        @endforeach
                    </div>
                    ...
                    @if ($shipment->barcode != null)
                        <div class="margin-top barcode-container float-right">
                            @php
                                echo '<img src="data:image/png;base64,' . $d->getBarcodePNG($shipment->code, 'C128') . '" alt="barcode"   />';
                            @endphp
                        </div>
